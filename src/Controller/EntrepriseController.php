...
class EntrepriseController extends AbstractController
{
    ...
    /**
     * @Route("/{reference}", name="entreprise_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{reference}/edit", name="entreprise_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{reference}", name="entreprise_delete", methods={"POST"})
     */
    public function delete(Request $request, Entreprise $entreprise): Response
    {
        if ($this->isCsrfTokenValid('delete'.$entreprise->getReference(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
