...
class PaysController extends AbstractController
{
    ...
    /**
     * @Route("/{reference}", name="pays_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{reference}/edit", name="pays_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{reference}", name="pays_delete", methods={"POST"})
     */
    public function delete(Request $request, Pays $pay): Response
    {
        if ($this->isCsrfTokenValid('delete'.$pay->getReference(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
