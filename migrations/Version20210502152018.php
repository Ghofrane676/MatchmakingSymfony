 ...
 */
final class Version20210502152018 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD pays VARCHAR(255) NOT NULL, ADD société VARCHAR(255) NOT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD siteweb VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users DROP pays, DROP société, DROP adresse, DROP siteweb');
    }
}
